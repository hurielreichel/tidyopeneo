...
#' This is understood as the **starting point** when working with openeowrap. (optional)
...
#' openEO connection and create a datacube object (openeowrap object) with the given collection.
#' Defining data is recommended to use once you need to apply a processes that is not included in
#' openeowrap and you want to come back to use openeowrap functions.
#' @export
